			...
			<div class="section group">
				...
				<div class="listview_1_of_2 images_1_of_2">
				    ...
				    <div class="text list_2_of_1">
						...
						<div class="button"><span><a href="detail.php?proid=<?php echo $resultdell['productId']?>">Add to cart</a></span></div>
				   </div>
			   </div>	
			   <?php
}}
			   ...
			   <?php
				...
				<div class="listview_1_of_2 images_1_of_2">
					<div class="listimg listimg_2_of_1">
						  <a href="preview.html"><img src="admin/uploads/<?php echo $resultasus['image']?>" alt="" / ></a>
					</div>
					<div class="text list_2_of_1">
						  <h2>Asus</h2>
						  <p><?php echo $resultasus['productName']?></p>
						  <div class="button"><span><a href="detail.php?proid=<?php echo $resultasus['productId']?>">Add to cart</a></span></div>
					</div>
				</div>
				 <?php
}}
