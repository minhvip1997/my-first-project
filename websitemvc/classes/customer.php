...
class customer
{
   ...
   public function insert_customers($data){
    ...
    return $alert;
         ...
         $query = "INSERT INTO tbl_customer(name,city,zipcode,email,address,country,phone,password) VALUES
        ('$name','$city','$zipcode','$email','$address','$country','$phone','$password')";
      $result = $this->db->insert($query);
      if($result){
            $alert = "<span class='success'>Customer Created Success</span>>";
            return $alert;
        }else{
            $alert = "<span class='success'>Customer  Not Created Success</span>";
            return $alert;
        }
    }
  }
   ...
   public function login_customers($data){
    ...
    if($result_check != false){
        ...
        $alert = "<span class='error'>Email and password does not match</span>";
    return $alert; 
    }
  }
   }
   ...
   public function update_customers($data,$id){
    ...
    return $alert;
      ...
      $result = $this->db->insert($query);
      if($result){
            $alert = "<span class='success'>Customer Update Success</span>>";
            return $alert;
        }else{
            $alert = "<span class='error'>Customer  Not Update Success</span>";
            return $alert;
        }
